...
var pathElems = require("./_collections.js").pathElems,
    ...
    cleanupOutData = require("../lib/optsvg/tools").cleanupOutData,
    roundData,
    precision,
    error,
    arcThreshold,
        ...
        if (data) {
            ...
            if (
                ...
                var r = roundData([circle.radius])[0],
                    ...
                    sweep =
                        sdata[5] * sdata[0] - sdata[4] * sdata[1] > 0 ? 1 : 0,
                    arc = {
                        instruction: "a",
                ...
                if (
                    ...
                    var prevData =
                        prev.instruction == "a" ? prev.sdata : prev.data;
                ...
                for (
                    ...
                    if (isConvex(nextData) && isArc(nextData, relCircle)) {
                        ...
                        if (2 * Math.PI - angle > 1e-3) {
                            ...
                            arc.data[5] =
                                2 * (relCircle.center[0] - nextData[4]);
                            arc.data[6] =
                                2 * (relCircle.center[1] - nextData[5]);
                            arc.coords = [
                ...
                if (
                    ...
                    if (hasPrev) {
                        ...
                        relSubpoint[0] +=
                            prevArc.data[5] - prev.data[prev.data.length - 2];
                        relSubpoint[1] +=
                            prevArc.data[6] - prev.data[prev.data.length - 1];
                        prev.instruction = "a";
                    ...
                    if (arcCurves.length == 1) {
                        ...
                        path.splice.apply(
                            path,
                            [index + 1, arcCurves.length - 1 - hasPrev].concat(
                                output
                            )
                        );
                    }
        ...
        if (
            ...
            (absoluteDataStr.length < relativeDataStr.length &&
                !(
                    ...
                    (data[0] < 0 ||
                        (/^0\./.test(data[0]) &&
                            prev.data[prev.data.length - 1] % 1))
                ))
        ) {
...
function findCircle(curve) {
    ...
    if (
        ...
        [1 / 4, 3 / 4].every(function (point) {
            return (
                Math.abs(
                    getDistance(getCubicBezierPoint(curve, point), center) -
                        radius
                ) <= tolerance
            );
        })
